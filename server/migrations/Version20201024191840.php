 ...
 */
final class Version20201024191840 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client_search_offer (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, property_offering_type VARCHAR(255) NOT NULL, property_type VARCHAR(255) NOT NULL, filters LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_ACE9E6D619EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, identifier VARCHAR(255) NOT NULL, name VARCHAR(280) NOT NULL, property_type VARCHAR(200) NOT NULL, offering_type VARCHAR(200) NOT NULL, property_market_type VARCHAR(200) NOT NULL, property_legal_status VARCHAR(200) NOT NULL, property_contract_type VARCHAR(200) NOT NULL, total_price VARCHAR(255) DEFAULT NULL, footage DOUBLE PRECISION DEFAULT NULL, number_of_rooms INT DEFAULT NULL, district VARCHAR(255) DEFAULT NULL, flat_number INT DEFAULT NULL, available_from DATETIME NOT NULL, state VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_DA460427772E836A (identifier), INDEX IDX_DA4604277E3C61F9 (owner_id), INDEX name_idx (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
