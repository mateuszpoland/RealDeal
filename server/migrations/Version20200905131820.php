 ...
 */
final class Version20200905131820 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, identifier VARCHAR(255) NOT NULL, name VARCHAR(280) NOT NULL, total_price VARCHAR(255) DEFAULT NULL, footage DOUBLE PRECISION DEFAULT NULL, number_of_rooms INT DEFAULT NULL, district VARCHAR(255) DEFAULT NULL, flat_number INT DEFAULT NULL, state VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_DA460427772E836A (identifier), INDEX IDX_DA46042719EB6921 (client_id), INDEX name_idx (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
